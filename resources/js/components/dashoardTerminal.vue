<template>
    <div class="areadash">
        ...
        <v-row>
            ...
            <v-col cols="12" md="12"  v-if="Object.keys(proyectoSelect).length>0  && ventanas.archivos===true"  >
                <v-btn class="greenD white--text" @click="vista=1"><v-icon> mdi mdi-card-outline</v-icon></v-btn>
           <v-btn class="greenD white--text" @click="vista=2"><v-icon >mdi mdi-land-rows-vertical</v-icon></v-btn>


            </v-col>

            <v-col cols="12" md="12"  v-if="vista===2 && Object.keys(proyectoSelect).length>0  && ventanas.archivos===true "  >
            <v-tabs v-model="modtabs">
                <v-tab>
                    Tareas
                </v-tab>
                <v-tab>
            ...
            <v-tabs-items v-model="modtabs">
                <v-tab-item v-if="Object.keys(proyectoSelect).length>0  && ventanas.archivos===true">
